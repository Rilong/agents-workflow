...
- Plan files are saved in `docs/` as `YYYY-MM-DD-feature-name.md`
- Use today's date and a kebab-case slug derived from the task (e.g., "add auth" → `docs/2026-05-14-add-auth.md`)
- **NEVER** save plans in the project root or inside `.claude/`
